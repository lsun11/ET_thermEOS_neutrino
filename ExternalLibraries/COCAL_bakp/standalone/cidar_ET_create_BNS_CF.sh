...
path_to_src=/home/lsun11/ET3/Cactus/arrangements/ExternalLibraries/COCAL
path_to_lib=/home/lsun11/ET3/Cactus/arrangements/ExternalLibraries/COCAL/lib
FCOMP=gfortran
#FCOMP=ifort
FFLAGS=
#-O2
...
/bin/cp -f  coc2cac_ini.f90 coc2cac_ini_sub.F90              ${path_to_src}/src/${new_dir_name}/Main_utility/
...
#${FCOMP} ${FFLAGS} -c coc2cac_ini_sub.F90;   rm *.mod

#echo "Creating library..."
##ar rcvf libcocalnsns.a coc2pri.o 
#ar rcvf libcocalnsns.a coc2cac_ini_sub.o

#rm coc2pri.o 
#rm coc2cac_ini_sub.o
