...
path_to_src=/home/lsun11/ET3/Cactus/arrangements/ExternalLibraries/COCAL/Cocalthorn
...
/bin/cp -f  coc2cac_ini_sub.F90              ${path_to_src}/src/${new_dir_name}/Main_utility/
