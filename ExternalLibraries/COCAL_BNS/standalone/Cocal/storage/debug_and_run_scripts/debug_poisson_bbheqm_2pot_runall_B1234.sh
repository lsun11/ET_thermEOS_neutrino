...
cp ../parameter_sample/bbh_eqm/B1/*.* work_area_poisson_test_B1/.
cp ../parameter_sample/bbh_eqm/B2/*.* work_area_poisson_test_B2/.
cp ../parameter_sample/bbh_eqm/B3/*.* work_area_poisson_test_B3/.
cp ../parameter_sample/bbh_eqm/B4/*.* work_area_poisson_test_B4/.
