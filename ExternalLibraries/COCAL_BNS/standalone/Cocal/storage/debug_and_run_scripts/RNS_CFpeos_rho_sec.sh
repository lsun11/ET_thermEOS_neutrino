...
cp -rfp ./ctrl_area_RNS/peos_parameter.dat   ./${work_dir_name}_000/.
cp -rfp ./ctrl_area_RNS/ovpar_peos.dat       ./${work_dir_name}_000/.
cp -rfp ./ctrl_area_RNS/rnspar_drot.dat      ./${work_dir_name}_000/.
