...
!cal      call calc_qua_loc_spin_out
...
!cal      call excurve_CF('bh')             !   3rd order midpoint from ir0=0,...
!cal      call excurve_CF_gridpoint_bhex    !   4th order from ir0=0,...

!     copy radi (i=5) of COCP1 to ARCP
!cal      def_matter_param_real_(5,nmpt) = def_matter_param_real_(5,1)
!cal      radi = def_matter_param_real_(5,nmpt)
!cal      write(6,*) '----------------------------------------- dis, radi:', dis, radi
!cal      call calc_mass_asympto('ns')
!cal      call calc_angmom_asympto('ns')
!cal      call calc_admmom_asympto('ns')
!cal      def_matter_param_real_(5,nmpt) = 0.0d0
!cal      radi = def_matter_param_real_(5,nmpt)
!cal      call copy_def_quantities_BNS_to_mpt(impt)
    end if
  end do
!
!cal  char1 = 'bnsphys_all_mpt.txt'
