subroutine iteration_helmholtz_solver_outgoing_test(iter_count)
...
! --
    ...
    call helmholtz_solver_outgoing(sou,pot)
    psi_bak = psi
...
!
  ...
  deallocate(psi_bak)
end subroutine iteration_helmholtz_solver_outgoing_test
