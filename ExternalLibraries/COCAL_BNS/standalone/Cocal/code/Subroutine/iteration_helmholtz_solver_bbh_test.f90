subroutine iteration_helmholtz_solver_bbh_test(iter_count)
  ...
  use interface_helmholtz_solver_binary_bhex_homosol
  implicit none
...
! --
    ...
    call helmholtz_solver_binary_bhex_homosol(psi,sou,pot)
    psi_bak = psi
...
!
  ...
  deallocate(pot)
  deallocate(psi_bak)
end subroutine iteration_helmholtz_solver_bbh_test
