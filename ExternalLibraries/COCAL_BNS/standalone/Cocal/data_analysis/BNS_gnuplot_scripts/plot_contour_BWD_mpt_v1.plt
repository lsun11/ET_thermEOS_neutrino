...
reset
x1=-2;  x2=5.0;
y1=-3.5;  y2=3.5 ; xns1=-1.5  ;  xns2=1.5 ;
ds=3.0   ;
set grid ;
set size sq 1.0,1.0;
...
unset key
set view map;
set cntrparam levels incremental  0.9991, 0.00003, 1.0
set table "ns1.dat"
...
unset key
set view map;
set cntrparam levels incremental  0.0, 0.000008, 0.00019
set table "ns1.dat"
...
unset key
set view map;
set cntrparam levels incremental  0.00000002, 0.00000008, 0.0001
set table "ns1.dat"
splot "bns_contour_xy_mpt1.dat" u ($1):2:13
unset table
set table "ns2.dat"
splot "bns_contour_xy_mpt2.dat" u (ds-$1):2:13
unset table
