...
set term postscript enhanced eps color dashed "Helvetica" 24
...
plot "table_shift_y.dat" notitle with image, \
     "table.dat" using 1:2 notitle with lines lt -1 lw 1, \
     "rnsshape_reduced_xz.dat" using 1:2 notitle w lines lt 2 lw 1.5, \
     "rnsshape_seq_xz.dat" using 1:2 notitle w lines lt -1 lw 1
