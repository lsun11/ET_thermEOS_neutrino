...
set output "contour_sftvector_xy-plane.eps"
set xlabel "x/R"
set ylabel "y/R"
plot "gnb_fig_sft.dat" notitle w vector lw 1.5, \
     "gnb_fig_rseq.dat" using 1:2 notitle with lines lw 1.5
...
set xlabel "x/R"
set ylabel "z/R"
set key 3,3.2 title "Rest density and velocity field in xy-plane"
...
set output
set term postscript eps color solid 22
set output "contour_fluidvelocity_xy-plane.eps"
set xlabel "x/R"
set ylabel "y/R"
