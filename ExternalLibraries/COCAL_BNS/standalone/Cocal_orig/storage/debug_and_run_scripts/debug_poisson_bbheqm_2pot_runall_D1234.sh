...
cp ../parameter_sample/bbh_eqm/D1/*.* work_area_poisson_test_D1/.
cp ../parameter_sample/bbh_eqm/D2/*.* work_area_poisson_test_D2/.
cp ../parameter_sample/bbh_eqm/D3/*.* work_area_poisson_test_D3/.
cp ../parameter_sample/bbh_eqm/D4/*.* work_area_poisson_test_D4/.
