...
! 
  integer :: ia, im, il, nlgtmp, ia13, ia24
...
! 
! 
  if (char_io.eq.'in') then ; ia13 = 1 ; ia24 = 2 ; end if
  if (char_io.eq.'ou') then ; ia13 = 3 ; ia24 = 4 ; end if
!
  call alloc_array3d(work1c, 1, ntg, 0, nlg, ia13, ia24)
  call alloc_array3d(work1s, 1, ntg, 0, nlg, ia13, ia24)
  call alloc_array3d(work2c, 0, nlg, 0, nlg, ia13, ia24)
  call alloc_array3d(work2s, 0, nlg, 0, nlg, ia13, ia24)
...
! 
  ...
  do ir = 0, nrg
    do il = 0, nlg
      do im = 0, nlg
        work3c(il,im,ir) = &
        &                + work2c(il,im,ia13)*gfnsf(il,ir,ia13) &
        &                - work2c(il,im,ia24)*gfnsf(il,ir,ia24)
        work3s(il,im,ir) = &
        &                + work2s(il,im,ia13)*gfnsf(il,ir,ia13) &
        &                - work2s(il,im,ia24)*gfnsf(il,ir,ia24)
      end do
    end do
  end do
! 
