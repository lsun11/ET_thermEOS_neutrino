...
set table "ns1.dat"
splot "bns_contour_xz_mpt1.dat" u ($1):2:7 w lines
unset table
#
reset
set grid ;
...
set output "bns_contour_xz_mpt1_psi.eps"
set object circle at 2.5,0 size 1.125 fs border lc rgbcolor "green"
plot "bnsshape_xz_mpt1.dat" u (rs1*($1)):(rs1*($2))  w filledcurve fs solid 0.1 lc rgb '#0000FF' notitle,\
     "bnsshape_xz_mpt2.dat" u (ds-rs2*($1)):(-rs2*($2))  w filledcurve fs solid 0.1 lc rgb '#0000FF' notitle,\
...
#set terminal postscript enhanced eps solid color "Helvetica" 24
#set output "bns_contour_xz_mpt1_psi.eps"
##splot "bns_contour_xz_mpt1.dat" u ($1+xns1):2:7 w line palette 
#splot "bns_contour_xz_mpt1.dat" u ($1+xns1):2:7 w lines
#
...
set table "ns1.dat"
splot "bns_contour_xz_mpt1.dat" u ($1):2:8 w lines
unset table
#
reset
set grid ;
...
set cntrparam levels incremental  0.51, 0.01, 1.0
set terminal postscript enhanced eps solid color "Helvetica" 24
set output "bns_contour_xz_mpt1_alph.eps"
set object circle at 2.5,0 size 1.125 fs border lc rgbcolor "green"
plot "bnsshape_xz_mpt1.dat" u (rs1*($1)):(rs1*($2))  w filledcurve fs solid 0.1 lc rgb '#0000FF' notitle,\
     "bnsshape_xz_mpt2.dat" u (ds-rs2*($1)):(-rs2*($2))  w filledcurve fs solid 0.1 lc rgb '#0000FF' notitle,\
          "ns1.dat" w l lc rgb '#FF0000' notitle
...
#set terminal postscript enhanced eps solid color "Helvetica" 24
#set output "bns_contour_xz_mpt1_alph.eps"
#splot "bns_contour_xz_mpt1.dat" u ($1+xns1):2:8 w lines
...
set table "ns1.dat"
splot "bns_contour_xz_mpt1.dat" u ($1):2:3
unset table
set table "ns2.dat"
splot "bns_contour_xz_mpt2.dat" u (ds-$1):2:3
unset table
...
set terminal postscript enhanced eps solid color "Helvetica" 24
set output "bns_contour_xz_mpt1_emd.eps"
plot "bnsshape_xz_mpt1.dat" u (rs1*($1)):(rs1*($2))  w filledcurve fs solid 0.1 lc rgb '#0000FF' notitle,\
     "bnsshape_xz_mpt2.dat" u (ds-rs2*($1)):(-rs2*($2))  w filledcurve fs solid 0.1 lc rgb '#0000FF' notitle,\
...
set table "ns1.dat"
splot "bns_contour_xz_mpt1.dat" u ($1):2:14
unset table
set table "ns2.dat"
splot "bns_contour_xz_mpt2.dat" u (ds-$1):2:14
unset table
...
set terminal postscript enhanced eps solid color "Helvetica" 24
set output "bns_contour_xz_mpt1_rho.eps"
plot "bnsshape_xz_mpt1.dat" u (rs1*($1)):(rs1*($2))  w filledcurve fs solid 0.1 lc rgb '#0000FF' notitle,\
     "bnsshape_xz_mpt2.dat" u (ds-rs2*($1)):(-rs2*($2))  w filledcurve fs solid 0.1 lc rgb '#0000FF' notitle,\
     "ns1.dat" w l lc rgb '#FF0000' notitle, "ns2.dat" w l lc rgb '#FF0000' notitle
...
set ylabel "{/Helvetica=28 z}"  ;
 ...
 set table "ns3.dat"
 splot "bns_contour_xz_mpt1.dat" u ($1):2:12
 unset table
 set table "ns4.dat"
 splot "bns_contour_xz_mpt2.dat" u (ds-$1):2:12
 unset table
...
set cntrparam levels incremental  -0.2, 0.01, 0.2
set terminal postscript enhanced eps solid color "Helvetica" 24
set output "bns_contour_xz_mpt1_vep.eps"
plot "bnsshape_xz_mpt1.dat" u (rs1*($1)):(rs1*($2))   w filledcurve fs solid 0.1 lc rgb '#0000FF' notitle,\
     "bnsshape_xz_mpt2.dat" u (ds-rs2*($1)):(-rs2*($2)) w filledcurve fs solid 0.1 lc rgb '#0000FF' notitle,\
...
#set parametric
#plot "./BBH_contour_xz_new.dat" u 1:2 notitle w lines,  bhp2+re*cos(t),re*sin(t) notitle lt  2, \
