...
reset
x1=-1.25;  x2=1.25;
y1=-1.25;  y2=1.25 ; xns1=-1.25  ;  xns2=1.25 ;
...
set table "ns1.dat"
splot "bns_contour_yz_mpt1.dat" u ($1):2:7 w lines
unset table
#
reset
set grid ;
...
set output "bns_contour_yz_mpt1_psi.eps"
set object circle at 2.5,0 size 1.125 fs border lc rgbcolor "green"
plot "bnsshape_yz_mpt1.dat" u (rs1*($1)):(rs1*($2))  w filledcurve fs solid 0.1 lc rgb '#0000FF' notitle,\
...
set table "ns1.dat"
splot "bns_contour_yz_mpt1.dat" u ($1):2:8 w lines
unset table
#
reset
set grid ;
...
set cntrparam levels incremental  0.51, 0.01, 1.0
set terminal postscript enhanced eps solid color "Helvetica" 24
set output "bns_contour_yz_mpt1_alph.eps"
set object circle at 2.5,0 size 1.125 fs border lc rgbcolor "green"
plot "bnsshape_yz_mpt1.dat" u (rs1*($1)):(rs1*($2))  w filledcurve fs solid 0.1 lc rgb '#0000FF' notitle,\
     "ns1.dat" w l lc rgb '#FF0000' notitle
...
set table "ns1.dat"
splot "bns_contour_yz_mpt1.dat" u ($1):2:3
unset table
set table "ns2.dat"
splot "bns_contour_yz_mpt2.dat" u (ds-$1):2:3
unset table
...
set terminal postscript enhanced eps solid color "Helvetica" 24
set output "bns_contour_yz_mpt1_emd.eps"
plot "bnsshape_yz_mpt1.dat" u (rs1*($1)):(rs1*($2))  w filledcurve fs solid 0.1 lc rgb '#0000FF' notitle,\
     "ns1.dat" w l lc rgb '#FF0000' notitle
...
set table "ns1.dat"
splot "bns_contour_yz_mpt1.dat" u ($1):2:14
unset table
set table "ns2.dat"
splot "bns_contour_yz_mpt2.dat" u (ds-$1):2:14
unset table
...
set terminal postscript enhanced eps solid color "Helvetica" 24
set output "bns_contour_yz_mpt1_rho.eps"
plot "bnsshape_yz_mpt1.dat" u (rs1*($1)):(rs1*($2))  w filledcurve fs solid 0.1 lc rgb '#0000FF' notitle,\
     "ns1.dat" w l lc rgb '#FF0000' notitle
...
set ylabel "{/Helvetica=28 z}"  ;
 ...
 set table "ns3.dat"
 splot "bns_contour_yz_mpt1.dat" u ($1):2:12
 unset table
 set table "ns4.dat"
 splot "bns_contour_yz_mpt2.dat" u (ds-$1):2:12
 unset table
...
set cntrparam levels incremental  -0.2, 0.01, 0.2
set terminal postscript enhanced eps solid color "Helvetica" 24
set output "bns_contour_yz_mpt1_vep.eps"
plot "bnsshape_yz_mpt1.dat" u (rs1*($1)):(rs1*($2))   w filledcurve fs solid 0.1 lc rgb '#0000FF' notitle,\
     "ns3.dat" w l lc rgb '#FF0000' notitle
