...
set label "{/Helvetica=28 COCP-BH}" at  -5,1.6e-05 ;

set ylabel "{/Symbol=32 b}_z"
set output 'plot_bvzd_x_ex.eps'
plot "./Cocal_debug/work_area_BBH_D3/plot_x.dat" u 1:6 w l lw 2 lt 1 notitle,\
     "./Cocal_debug/work_area_BBH_D3/plot_x.dat" u (abs($1)>1.06*re?1/0:ds-$1):($6) w l lw 2 lt 2 notitle
...
set label "{/Helvetica=28 COCP-BH}" at  -5,0.00011 ;

set ylabel "{/Symbol=32 b}_z"
set output 'plot_bvzd_y_ex.eps'
