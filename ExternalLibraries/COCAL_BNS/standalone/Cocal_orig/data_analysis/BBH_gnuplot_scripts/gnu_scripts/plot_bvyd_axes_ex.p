...
set label "{/Helvetica=28 COCP-BH}" at  -5,0.11 ;

set ylabel "{/Symbol=32 b}_y"
set output 'plot_bvyd_x_ex.eps'
plot "./Cocal_debug/work_area_BBH_D3/plot_x.dat" u 1:5 w l lw 2 lt 1 notitle,\
     "./Cocal_debug/work_area_BBH_D3/plot_x.dat" u (abs($1)>1.06*re?1/0:ds-$1):(-$5) w l lw 2 lt 2 notitle
...
set label "{/Helvetica=28 COCP-BH}" at  -5,0.10 ;

set ylabel "{/Symbol=32 b}_y"
set output 'plot_bvyd_y_ex.eps'
