...
!
!  call alloc_array3d(detg, 0, nrg, 0, ntg, 0, npg)
!  call alloc_array4d(sou_qij,1,nrg,1,ntg,1,npg,1,6)
!
...
!
  ...
  call alloc_array4d(dtrk, 1, nrg, 1, ntg, 1, npg, 1, 3)
...
!
!  call alloc_array5d(Lij_grid, 0, nrg, 0, ntg, 0, npg, 1, 3, 1, 3)
!  call alloc_array5d(L1ij_grid, 0, nrg, 0, ntg, 0, npg, 1, 3, 1, 3)
  ...
  call alloc_array4d(rab2d, 0, nrg, 0, ntg, 0, npg, 1, 6)
