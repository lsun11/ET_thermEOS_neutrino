subroutine liegmab_grid
  use grid_parameter, only : nrg, ntg, npg
  use def_Lie_derivatives, only : elpxx_grid, elpxy_grid, elpxz_grid, &
  ...
  integer :: ipg, irg, itg
!
! --- Compute conformal invariant derivative of tgamma w.r.t. phi. 
!
  fa13 = 1.0d0/3.0d0
  dphiu(1:3,1:3) = 0.0d0
  dphiu(1,2) =-1.0d0
