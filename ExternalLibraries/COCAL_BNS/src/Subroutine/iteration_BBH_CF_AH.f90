subroutine iteration_BBH_CF_AH(iter_count)
...
!---
    ...
    call bh_boundary_AH(sou_bhsurf,dsou_bhsurf,'psi ')
...
!---
    ...
    call bh_boundary_AH(sou_bhsurf,dsou_bhsurf,'alps')
...
!---
    ...
    do ii = 1, 3
      ...
      if      (ii.eq.1) then 
        call bh_boundary_AH(sou_bhsurf,dsou_bhsurf,'bvxd')
        call outer_boundary_d_bvxd(sou_outsurf)
      else if (ii.eq.2) then
        call bh_boundary_AH(sou_bhsurf,dsou_bhsurf,'bvyd')
        call outer_boundary_d_bvyd(sou_outsurf)
      else if (ii.eq.3) then
        call bh_boundary_AH(sou_bhsurf,dsou_bhsurf,'bvzd')
...
end subroutine iteration_BBH_CF_AH
