...
!write(6,'(a20,1p,3e20.12)') "**************emdc", emdc,ome,radi
!write(6,'(a20,1p,3e20.12)') "**************psi ", psi(irin,itin,ipin),psi(irmid,itmid,ipmid),psi(irout,itout,ipout)
...
!      ov2out = ovout**2+bvxd(nrf,ntgxy,0)**2+bvzd(nrf,ntgxy,0)**2
    ov2in  = ovin**2  + velx**2
    ov2mid = ovmid**2 + velx**2
    ov2out = ovout**2 + velx**2
