subroutine iteration_only_grav(iter_count)_peos
...
! --
    ...
    sou2(1:nrg, 1:ntg, 1:npg) = souvec(1:nrg, 1:ntg, 1:npg, 1)
    call poisson_solver(sou2,potx)
    sou2(1:nrg, 1:ntg, 1:npg) = souvec(1:nrg, 1:ntg, 1:npg, 2)
    call poisson_solver(sou2,poty)
    sou2(1:nrg, 1:ntg, 1:npg) = souvec(1:nrg, 1:ntg, 1:npg, 3)
    call poisson_solver(sou2,potz)
    call poisson_solver(sou,pot)
    souvec(0:nrg, 0:ntg, 0:npg, 1) = potx(0:nrg, 0:ntg, 0:npg)
    souvec(0:nrg, 0:ntg, 0:npg, 2) = poty(0:nrg, 0:ntg, 0:npg)
    souvec(0:nrg, 0:ntg, 0:npg, 3) = potz(0:nrg, 0:ntg, 0:npg)
...
!
  ...
  deallocate(potrs)
  deallocate(souvec)
end subroutine iteration_only_grav_peos
