subroutine printout_physq_WL_MHD(iseq,flag_restmass)
...
!
  ...
  write(100,'(a22,1p,2e23.15)') ' Electric charge  Q = ', charge, charge_asymp
!
...
!
  ...
  write(100,'(a22,1p,2e23.15)') ' M em field  energy = ', M_emfene
  write(100,'(a22,1p,2e23.15)') ' W grav energy      = ', W_gravene
  write(100,'(a22,1p,2e23.15)') ' T/|W|              = ', ToverW
  write(100,'(a22,1p,2e23.15)') ' P/|W|              = ', PoverW
  write(100,'(a22,1p,2e23.15)') ' M/|W|              = ', MoverW
  write(100,'(a22,1p,2e23.15)') ' Virial relation    = ', Virial
  write(100,'(a22,1p,2e23.15)') ' MtorB field energy = ', M_torBene
  write(100,'(a22,1p,2e23.15)') ' MpolB field energy = ', M_polBene
  write(100,'(a22,1p,2e23.15)') ' MeleE field energy = ', M_eleEene
  write(100,'(a22,1p,2e23.15)') ' MtorB/|W|          = ', MtorBoverW
  write(100,'(a22,1p,2e23.15)') ' MpolB/|W|          = ', MpolBoverW
  write(100,'(a22,1p,2e23.15)') ' MeleE/|W|          = ', MeleEoverW
...
!
end subroutine printout_physq_WL_MHD
