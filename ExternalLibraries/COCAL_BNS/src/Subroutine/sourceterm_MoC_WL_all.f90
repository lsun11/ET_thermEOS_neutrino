...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        hhzyu = hhyzu
!
        call grgrad_gridpoint_type0(bvxd,pdbvxdx,pdbvxdy,pdbvxdz,irg,itg,ipg)
        call grgrad_gridpoint_type0(bvyd,pdbvydx,pdbvydy,pdbvydz,irg,itg,ipg)
        call grgrad_gridpoint_type0(bvzd,pdbvzdx,pdbvzdy,pdbvzdz,irg,itg,ipg)
!
