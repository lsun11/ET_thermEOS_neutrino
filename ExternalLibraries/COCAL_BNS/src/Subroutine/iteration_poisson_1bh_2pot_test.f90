subroutine iteration_poisson_1bh_2pot_test(iter_count)
...
!  use interface_sourceterm_volume_int_bbh_2pot_test
  use interface_sourceterm_1bh_2pot_test
  use interface_poisson_solver_1bh_homosol
!  use interface_poisson_solver_binary_bhex
!  use interface_bh_boundary_test
  use interface_bh_boundary_1bh_nh_psi_test
  use interface_bh_boundary_1bh_nh_alph_test
!
  implicit none
...
!    call bh_boundary_test('nh',sou_bhsurf,dsou_bhsurf)
    call bh_boundary_1bh_nh_psi_test(dsou_bhsurf)
...
end subroutine iteration_poisson_1bh_2pot_test
