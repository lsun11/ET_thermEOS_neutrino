...
contains
subroutine allocate_legendre_irbns
  use phys_constant,  only : long
...
!
end subroutine allocate_legendre_irbns

SUBROUTINE legendre_irbns
...
!  call alloc_array3d(hdtyplmg, 0, nlg, 0, nlg, 1, ntg)
  do it = 0, ntg
    theta = thg(it)
    call legendre_irbns_theta(pnag,dtpnag,theta)
...
!
end subroutine legendre_irbns
SUBROUTINE legendre_irbns_theta(pnag,dtpnag,theta)
...
end subroutine legendre_irbns_theta
end module legendre_fn_irbns_grav
