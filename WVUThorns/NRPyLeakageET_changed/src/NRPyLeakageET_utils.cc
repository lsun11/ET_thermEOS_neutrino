...
extern NRPyLeakageET_compute_optical_depth_change(CCTK_ARGUMENTS, const int it);
extern NRPyLeakageET_CopyOpticalDepthsToAux(CCTK_ARGUMENTS);
...
extern NRPyLeakageET_optical_depths_initialize_to_zero(CCTK_ARGUMENTS);
extern NRPyLeakageET_compute_opacities(CCTK_ARGUMENTS);
extern NRPyLeakageET_SyncOpticalDepths(CCTK_ARGUMENTS);
extern NRPyLeakageET_optical_depths_PathOfLeastResistance(CCTK_ARGUMENTS); 
extern NRPyLeakageET_copy_opacities_and_optical_depths_to_previous_time_levels(CCTK_ARGUMENTS);
