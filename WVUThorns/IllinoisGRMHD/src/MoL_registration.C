...
extern "C" void IllinoisGRMHD_RegisterVars(CCTK_ARGUMENTS)
{
  ...
  /* radiation variables for neutrino M1 transport */
  //  group = CCTK_GroupIndex("IllinoisGRMHD::rad_conservatives");
  //  rhs = CCTK_GroupIndex("IllinoisGRMHD::rad_conservatives_rhs");
  //  ierr += MoLRegisterEvolvedGroup(group, rhs);
