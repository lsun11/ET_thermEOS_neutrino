...
extern "C" void IllinoisGRMHD_PostPostInitial_Set_Symmetries__Copy_Timelevels(CCTK_ARGUMENTS) {
  ...
  if(CCTK_EQUALS(Symmetry,"equatorial")) {
    ...
    //    ierr=CartSymGN(cctkGH,"IllinoisGRMHD::rad_conservatives"); if(ierr!=0) CCTK_VError(VERR_DEF_PARAMS,"Microsoft error code #1874109358120048. Grep it in the source code");
    //    ierr=CartSymGN(cctkGH,"IllinoisGRMHD::rad_primitives"); if(ierr!=0) CCTK_VError(VERR_DEF_PARAMS,"Microsoft error code #1874109358120049. Grep it in the source code");
